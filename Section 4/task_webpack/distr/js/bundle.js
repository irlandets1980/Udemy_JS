...
function modal(){
    ...
    more.addEventListener('click', function () {
        ...
        this.classList.add('more-splath');
        document.body.style.overflow = 'hidden';
    });

    close.addEventListener('click', function () {
        overlay.style.display = 'none';
        more.classList.remove('more-splath');
...
function slider(){
    ...
    function showSlides(n) {
        ...
        slides.forEach((item) => item.style.display = 'none'); //современный перебор с коллбэком - стрелочной функцией
